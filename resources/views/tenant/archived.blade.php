...
<head>
    ...
    <title>Aplikasi tidak aktif</title>
    <style>
...
<body>
    <div class="card">
        <h1>Aplikasi kasir ini sedang tidak aktif</h1>
        <p>
            <span class="brand">{{ $tenant->name }}</span> telah diarsipkan oleh pemiliknya
            dan untuk sementara tidak dapat diakses.
        </p>
    </div>
</body>
</html>
