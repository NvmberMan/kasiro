@php
    ...
    $messages = [
        'product-created'      => ['Produk Ditambahkan', 'Produk baru berhasil disimpan.'],
        'product-updated'      => ['Produk Diperbarui', 'Perubahan produk berhasil disimpan.'],
        'product-deleted'      => ['Produk Dihapus', 'Produk berhasil dihapus.'],
        'category-created'     => ['Kategori Ditambahkan', 'Kategori baru berhasil disimpan.'],
        'category-updated'     => ['Kategori Diperbarui', 'Perubahan kategori berhasil disimpan.'],
        'category-deleted'     => ['Kategori Dihapus', 'Kategori berhasil dihapus.'],
        'role-updated'         => ['Peran Diperbarui', 'Peran karyawan berhasil diubah.'],
        'employee-revoked'     => ['Akses Dicabut', 'Akses karyawan ke toko ini telah dicabut.'],
        'invitation-cancelled' => ['Undangan Dibatalkan', 'Undangan berhasil dibatalkan.'],
...
<div x-data="{ open: true, copied: false, link: @js($invitationLink),
    ...
    <div x-show="open" x-transition class="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6 text-center">
        ...
        <h3 class="text-lg font-bold text-gray-800">Undangan Dibuat</h3>
        <p class="text-sm text-gray-500 mt-1">Bagikan link berikut ke calon karyawan.</p>
        ...
        <button @click="open = false"
                class="mt-5 w-full py-2.5 bg-gray-100 text-gray-700 rounded-xl font-semibold text-sm hover:bg-gray-200 transition">
            Tutup
        </button>
    </div>
</div>
