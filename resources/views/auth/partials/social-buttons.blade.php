    ...
    <div class="mt-5">
        <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="bg-white px-3 text-gray-400">{{ __('atau') }}</span>
            </div>
        </div>

        <a href="{{ route('auth.google.redirect') }}"
           class="mt-5 inline-flex w-full items-center justify-center gap-3 rounded-full border border-lime-500 px-4 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-lime-50 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-offset-2">
